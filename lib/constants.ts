...
/** Web URL — fallback when Google Maps app is not installed */
export const GOOGLE_MAPS_WEB_URL =
...
/** iOS custom URL scheme — opens native Google Maps app directly */
export const GOOGLE_MAPS_DEEP_LINK =
  'comgooglemaps://?q=Subway+11017+S+Parker+Rd+Parker+CO&center=39.516461,-104.767263';
